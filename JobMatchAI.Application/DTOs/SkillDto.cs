...
namespace JobMatchAI.Application.DTOs
{
    public record SkillDto
    {
        ...
        [StringLength(maximumLength: 100, ErrorMessage = "Ontology ID cannot exceed 100 characters.")]
        public string? OntologyId { get; init; }

        public string? Description { get; init; }

        [StringLength(maximumLength: 500, ErrorMessage = "Icon URL cannot exceed 500 characters.")]
