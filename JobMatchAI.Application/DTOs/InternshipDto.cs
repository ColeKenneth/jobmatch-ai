...
namespace JobMatchAI.Application.DTOs
{
    public record InternshipDto
    {
        ...
        [StringLength(maximumLength: 50, ErrorMessage = "Positon name cannot exceed 50 characters.")]
        public string Position { get; init; } = string.Empty;

        [Range(minimum: 1, maximum: 120, ErrorMessage = "Duration must be between 1 and 120 months.")]
        public int DurationMonths { get; init; }

        [StringLength(maximumLength: 200, ErrorMessage = "Skills gained cannot exceed 200 characters.")]
