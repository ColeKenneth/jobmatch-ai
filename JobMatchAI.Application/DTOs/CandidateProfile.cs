...
namespace JobMatchAI.Application.DTOs
{
    public record CandidateProfile
    {
        ...
        [MaxLength(length: 150, ErrorMessage = "Full name cannot exceed 150 characters.")]
        public string FullName { get; init; } = string.Empty;

        [Required(ErrorMessage = "Your program name is required.")]
        [MaxLength(length: 100, ErrorMessage = "Program name cannot exceed 100 characters.")]
        public string Program { get; init; } = string.Empty;

        [Required(ErrorMessage = "Your GWA is required.")]
        [Range(minimum: 1.00, maximum: 5.00, ErrorMessage = "GWA must be between 1.00 and 5.00")]
        ...
        [Range(minimum: 1, maximum: 500, ErrorMessage = "Total experience must be between 1 and 500 months.")]
